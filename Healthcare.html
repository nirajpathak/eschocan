...
<body class="allPages">
    ...
    <section class="eshocan_hero_section" id="eshocan_hero_section">
        <div class="eshocan_hero_main" >
            <div class="eshocan_hero_desc" data-aos="fade-right" data-aos-duration="1000">
                <h1>Healthcare</h1>
                <h5>eShocan’s mechanical engineers are well-versed in medical device product development and optimizing healthcare outcomes</h5>
            </div>
            <div class="eshocan_hero_media">
                <div class="Hero_media_big one" id="div9" data-aos="fade-left" data-aos-duration="1000">
                    <img class="video" src="img/Healthcare/Hero.png">
                </img>
            </div>
        </div>
    ...
    <section class="industries-info" data-aos="fade-down" data-aos-duration="1000">
        <h2 class="industries-info-head">Medical Devices</h2>
        <p class="industries-info-copy">A crucial step for healthcare providers who want to reduce costs and deliver more efficient care is modernizing their medical devices. eShocan’s mechanical engineers are well-versed in medical device product development and optimizing healthcare outcomes. We understand the industry’s shifting regulatory needs and the requirement to invest in new technology to remain in compliance. Let us help you navigate this complex field with our healthcare industry expertise. Together, we’ll develop a more advanced product that is cost-effective and that will benefit human lives. </p>
        
        <h2 class="industries-info-head-auto-sub">We support healthcare product development offering following services</h2>
        <p class="industries-info-copy"></p>

        <div class="healthcare-info-block">
            <img src="img/Healthcare/main.png" alt="" data-aos="fade-right" data-aos-duration="1000">

            <div class="healthcare-info-point" data-aos="fade-right" data-aos-duration="1000">
