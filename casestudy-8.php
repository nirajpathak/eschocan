...
<body class="allPages">
    ...
    <section class="casestudy_pages">
        ...
        <h1>Requirements Engineering for Infotainment System of NA OEM</h1>
        <img src="img/casestudy/Picture8.png" class="cs_main">

        <p style="font-weight: bold">Overview</p>
        <p>•	Requirements/Systems Engineering of 40+ specification for high end Infotainment platform</p>
            <p>•	Areas include Audio Functions, Smart Navigation, Telematics and Connected Infotainment features</p>
            <p>•	Requirements management using IBM Rational tool chain and Atlasian</p>
            <p>•	Test data generation, requirement to test traceability</p>

        <p style="font-weight: bold">Project details</p>
        <p>•	Requirement Engineering, User requirement Elicitation</p>
        <p>•	Reverse Engineering and Requirement Verification from Test Platform</p>
        <p>•	Set up requirement management platform in DOORs Next Gen</p>
        <p>•	Review and approval of technical concepts</p>
        <p>•	Establishment of robust systems engineering process</p>
        <p>•	Continuous improvement – process improvement, DFMEA, DFSS, Test Coverage Improvement</p>
        <p>•	Quick Ramp up, Agile process model</p>

        <p style="font-weight: bolder;">eShocan’s Requirement gathering process flow-chart</p>
        <img src="img/casestudy/8_1.png" alt="" class="fig_img">
