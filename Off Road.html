...
<body class="allPages">
    ...
    <section class="eshocan_hero_section" id="eshocan_hero_section">
        <div class="eshocan_hero_main" >
            <div class="eshocan_hero_desc" data-aos="fade-right" data-aos-duration="1000">
                <h1>Off Road</h1>
                <h5>Whether it’s watercraft, all-terrain vehicles, or motorcycles, you can count on our product development, simulation, and design services to move your project from ideation to production.</h5>
            </div>
            <div class="eshocan_hero_media">
                <div class="Hero_media_big one" id="div9" data-aos="fade-left" data-aos-duration="1000">
                    <img class="video" src="img/Off Road/hero.jpeg">
                </img>
            </div>
        </div>
    ...
    <section class="industries-info" data-aos="fade-down" data-aos-duration="1000">
        <h2 class="industries-info-head">Off Road</h2>
        <p class="industries-info-copy">The same automotive expertise we extend to OEM’s and Tier 1 suppliers we extend to recreational vehicle clients. Whether it’s watercraft, all-terrain vehicles, or motorcycles, you can count on our product development, simulation, and design services to move your project from ideation to production. With our engineering and development competency, experience with applications, and global pool of talent, we are equipped to provide quality services across the off road product development life cycle.
            </p>
        ...
        <div class="industries-info-block">
            <img src="img/Off Road/main.png" alt="" data-aos="fade-right" data-aos-duration="1000">
