    ...
    <section class="eshocan_hero_section" id="eshocan_hero_section">
        <div class="eshocan_hero_main" >
            <div class="eshocan_hero_desc" data-aos="fade-right" data-aos-duration="1000">
                <h1 class="eshocan_hero_section_content">CAE Virtual<br>Simulation</h1>
            <h5>Product development can be costly and time-consuming. To avoid waste, we reduce the product life cycle cost and timeline with computer-aided engineering (CAE) tools. </h5>
            </div>
            <div class="eshocan_hero_media">
                <div class="Hero_media_big one" id="div9" data-aos="fade-left" data-aos-duration="1000">
                    <img class="video" src="img/simulation/hero.jpeg">
                </img>
            </div>
        </div>
...
<!--
    <section class="automotive-embed" data-aos="fade-down" data-aos-duration="1000">
        <div class="card-section">
            <div class="card-block">
                <div class="card-listing-parent">
                    <img src="img/simulation/FEM.png" alt="" class="card-block-img">
                    <h2>Finite Element Modeling and<br>Analysis (FEM & FEA)</h2>
                    <p class="card-copy">
                        
                    </p>
                    <ul class="card-listing">
                        <li>Trim Body/Body in White modeling and assembly</li>
                        <li>Structural level static and dynamic simulations</li>
                        <li>Durability and fatigue analysis</li>
                        <li>Noise, vibration and harshness (NVH)</li>
                        <li>Safety/Crash/Impact simulations</li>
                    </ul>
            ...
            <div class="card-block">
                <div class="card-listing-parent">
                    <img src="img/simulation/MBD.png" alt="" class="card-block-img">
                    <h2>Multibody Dynamics (MBD)<br>Simulations</h2>
                    <p class="card-copy"></p>
                    <ul class="card-listing">
                        <li>Rigid and flexible multibody systems</li>
                        <li>Sensitivity analysis</li>
                        <li>Vibration analysis</li>
                        <li>Coupled control/mechanical system analysis</li>
                        <li>Kinematics and kinetics</li>
                        <li>Loads and displacement</li>
                        <li>Kinetic, static, and dissipative energy distribution</li>
                        <li>Vehicular cornering, steering, quasi-static, and straight-line analysis</li>
                    </ul>
                </div><--card-listing-parent--
            </div><--card-block--
        </div><--card-section--
        ...
        <div class="card-section">
            <div class="card-block">
                <div class="card-listing-parent">
                    <img src="img/simulation/DO.png" alt="" class="card-block-img">
            ...
            <div class="card-block">
                <div class="card-listing-parent">
                    <img src="img/simulation/CFD.png" alt="" class="card-block-img">
...
-->
    <section class="industries-info" data-aos="fade-down" data-aos-duration="1000">
        ...
        <div class="industries-info-block-intership" data-aos="fade-down" data-aos-duration="1000">
            <div class="newcard">
                <img src="img/simulation/FEM.png" alt="" class="">
                ...
                <p class="industries-info-content-copy-teams">
                    ...
                    <br>●	Structural level static and dynamic simulations
                    <br>●	Durability and fatigue analysis
                    <br>●	Noise, vibration and harshness (NVH)
                    <br>●	Safety/Crash/Impact simulations
            ...
            <div class="newcard">
                <img src="img/simulation/DO.png" alt="" class="">
                <p class="internship-info-content-head-auto">
                    Design Optimization
                </p>
                <p class="industries-info-content-copy-teams">
        ...
        <div class="industries-info-block-intership" data-aos="fade-down" data-aos-duration="1000">
            <div class="newcard">
                <img src="img/simulation/CFD.png" alt="" class="">
                <p class="internship-info-content-head-auto">
            ...
            <div class="newcard">
                <img src="img/simulation/MBD.png" alt="" class="">
                <p class="internship-info-content-head-auto">
                    Multibody Dynamics (MBD) Simulations
                </p>
                <p class="industries-info-content-copy-teams" style="font-size: 12px;">
    ...
    <section class="casestudy"  style="margin-bottom: 3%;">
