...
<body class="allPages">
    ...
    <section class="casestudy_pages">
        <p>Date: 03/16/2022</p>
        <p>Author: Girish Mahendrakar</p>
        <h1>ADAS Surround View Vehicular Camera Package approach</h1>
        <img src="img/casestudy/Picture11.png" class="cs_main">

        <p>Integration of Cameras in vehicular system by using unique methodology of Camera entry Pupil point.</p>
        <p>a.	Seeing is believing, Cameras plays very much important role in sensing objects so it’s very much important to place camera based on viewing targets. 
            <br>b.	Each supplier camera has unique pattern of entry pupil point based on the type of lenses and combination of lenses. From the target object entry ray targets are created 
            From camera pupil points and can generate Target field of view.
            </p>

        <p style="font-weight: bold;">Challenges and Objectives:</p>
        <p>It is always a difficult to find a perfect location for camera in order to maximize the performance and meeting styling and engineering. The main objective is to provide camera NO Go surface with high confidence to see target objects without running optical simulation multiple times. </p>

        <p style="font-weight: bold;">How Product/Service Helped:</p>
        <p>By adopting this methodology cameras are packaged to body parts like Front Grill, Bumper, Mirror, and Tailgate area to see only targeted objects accurately. 
            <br>example: Rear View Camera FMVSS Targets. And simulation results are used for confirmation only.
            </p>

        <p style="font-weight: bold;">Results:</p>
        <p>Camera initially packaged based on Pupil point entry and Camera position is confirmed from optical simulation.</p>

        <img src="img/casestudy/11_1.png" alt="" class="fig_img">
    </section>
