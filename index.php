...
<body>
    ...
    <section class="eshocan_hero_section" id="eshocan_hero_section_home">
        <div class="eshocan_hero_main" >
            <div class="eshocan_hero_desc" data-aos="fade-right" data-aos-duration="1000">
                ...
                <a href="" class="hero-btn"> <span>Explore <i class="fas fa-arrow-circle-right"></i></a></span> 
                </a>
            </div>
            <div class="eshocan_hero_media"  >
                <div class="Hero_media_big one" id="div9">
                    <video autoplay loop muted class="video">
                        <source src="img/movie1.mp4" autoplay loop muted type="video/mp4">
                        <source src="img/movie1.ogg" type="video/ogg">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="Hero_media_big two" id="div10">
                    <video autoplay loop muted class="video">
                        <source src="img/movie.mp4" autoplay loop muted type="video/mp4">
                        <source src="img/movie.ogg" type="video/ogg">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="Hero_media_big three" id="div11">
                    <video autoplay loop muted class="video">
                        <source src="img/movie2.mp4" autoplay loop muted type="video/mp4">
                        <source src="img/movie2.ogg" type="video/ogg">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="Hero_media_big four" id="div12">
                    <video  autoplay loop muted class="video">
                        <source src="img/movie3.mp4" autoplay loop muted type="video/mp4">
                        <source src="img/movie3.ogg" type="video/ogg">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="eshocan_hero_media_small">
                    <a href="engineering.html"><img src="img/homepage_techservice.png" class="side-img-video" target="11" title="Technology" /></a>
                    <a href="services.html"><img src="img/homepage_pe.png" class=" side-img-video" target="10" title="product Engineering" /> </a>
                    <a href="consulting-and-staffing.html"><img src="img/homepage_it.png" class=" side-img-video" target="9" title="IT Consulting"/></a>
        ...
        <h2 data-aos="zoom-in"  data-aos-duration="1000">Industries in Focus</h2>
            <div class="row">
                <div class="col-sup desktop-block">
                    ...
                    <div class="col-r">
                        <a href="Heavy Machinery.html"><img src="img/industries/indust.png" class="side-img"  target="3"  data-aos="flip-right" data-aos-duration="1000"></a>
                ...
                <div class="col-sup desktop-block">
                    <div class="col">
                        <img src="img/industries/health.png" class="side-img" id="HEALTHCARE" target="5"  data-aos="flip-right" data-aos-duration="1000">
    ...
    <section class="homepage">
        <h2 data-aos="zoom-in" data-aos-duration="1000">Partners and client</h2>
