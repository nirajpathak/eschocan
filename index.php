                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <ul class="eshocan_nav_lvl-2">
                                                ...
                                                <li> <a href="HMI_Design.html">HMI Design</a></li>
        ...
        <div class="eshocan_footer_links_block">
            <div  data-aos="fade-down" data-aos-duration="1000">
                ...
                <div class="eshocan_social_media desktop-block" >
                    <ul>
                        <li><a href="https://www.facebook.com/eSchocan/"><i class="fab fa-facebook"></i></a></li>
                        <li><a href="https://twitter.com/eShocan"><i class="fab fa-twitter-square"></i></a></li>
                        <li><a href="https://www.linkedin.com/company/eshocan/"><i class="fab fa-linkedin"></i></a></li>
                    </ul>
                </div>
            </div>
