...
<body class="allPages">
    ...
    <section class="eshocan_hero_section" id="eshocan_hero_section">
        <div class="eshocan_hero_main" >
            <div class="eshocan_hero_desc" data-aos="fade-right" data-aos-duration="1000">
                ...
                <h5>We can create a thriving ecosystem of integrated
                    solutions and service providers so you can tap into 
                    economies of scale without being anchored by production costs</h5>
            </div>
            <div class="eshocan_hero_media"  >
                <div class="Hero_media_big one" id="div9" data-aos="fade-left" data-aos-duration="1000">
                    <img class="video" src="img/PlatformDev/picture2.png">
                </img>
            </div>
        </div>
    ...
    <section class="industries-info" data-aos="fade-down" data-aos-duration="1000">
        <h2 class="industries-info-head">Our platform development services</h2>
        ...
        <div class="industries-info-block">
            <img src="img/PlatformDev/img_service.png" alt="" data-aos="fade-right" data-aos-duration="1000">

            <div class=".industries-info-content" data-aos="fade-left" data-aos-duration="1000">
                <div class="industries-info-content-block-pd">
                    <p class="industries-info-content-head">
                        Digital platform design & development
                    </p>
                    <p class="industries-info-content-copy">
                        Work out the optimal digital platform architecture and bring it to life
                    </p>
                </div>
                <div class="industries-info-content-block-pd">
                    <p class="industries-info-content-head">
                ...
                <div class="industries-info-content-block-pd">
                    ...
                    <p class="industries-info-content-copy">
                        Our quality control and testing methodology fully complies with industry standards.
                        To increase the quality of software and shorten the development lifecycle, we implement
                        cloud-based DevOps, which allows for automated testing and continuous delivery.
                    </p>
                </div>
                <div class="industries-info-content-block-pd">
                    <p class="industries-info-content-head">
        ...
        <div class="industries-info-point" data-aos="fade-right" data-aos-duration="1000">
            <p class="industries-info-point-head">eShocan has the expertise from Concept Engineering including Proof of Concepts development using OS like AGL, QNX Linux and AOSP.</p>
            
            <ul>
                <li>Linux-OS compliance with GenIVI/AGL standar</li>
                <li>End to End Android Automotive Development & Implementation with QNX has the host OS and AOSP as the host OS and making use of Hypervisor                </li>
                <li>Strong hands-on experience with BSP development according to the OEM requirements</li>
                <li>Very strong experience with Linux or QNX OS/file system</li>
            </ul>
        </div>
    ...
    <section class="why-eshocan" data-aos="fade-right" data-aos-duration="1000"> 
        ...
        <div class="why-eshocan-parent">
            ...
            <div class="why-eshocan-block" data-aos="fade-down" data-aos-duration="1000">
