...
<body class="allPages">
        ...
        <div class="eshocan_hero_main" >
            ...
            <div class="eshocan_hero_media">
                <div class="Hero_media_big one" id="div9" data-aos="fade-left" data-aos-duration="1000">
                    <img class="video" src="img/Transportation/hero.png">
                </img>
            </div>
        </div>
    ...
    <section class="industries-info" data-aos="fade-down" data-aos-duration="1000">
        ...
        <h2 class="industries-info-head-auto-sub">Domains Supported</h2>
        <p class="industries-info-copy"></p>

        <div class="industries-info-block">

            <div class="trans-info-point" data-aos="fade-right" data-aos-duration="1000">
                <p class="trans-info-point-head">Rolling Stock</p>
                <ul>
                    <li>System level engineering</li>
                    <li>Vehicle engineering</li>
                    <li>Technical Documentation</li>
                    <li>Control System Development</li>
                    <li>Hardware and firmware development and Testing</li>
                    <li>Signaling</li>
                </ul>
                <p class="trans-info-point-head">Manufacturing Services</p>
                <ul>
                    <li>Fixture and Tool Design</li>
                    <li>Cable Harness Assembly</li>
                </ul>
            </div>

            <img src="img/Transportation/main.png" alt="" data-aos="fade-right" data-aos-duration="1000">

            <div class="trans-info-point" data-aos="fade-right" data-aos-duration="1000">
                <p class="trans-info-point-head">Signalling</p>
                <ul>
                    <li>Signal Design management</li>
                    <li>Technical Documentation</li>
                    <li>Safety engineering</li>
                </ul>
                <p class="trans-info-point-head">Motor design</p>
                <ul>
