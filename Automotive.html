...
<body class="allPages">
    ...
    <section class="eshocan_hero_section" id="eshocan_hero_section">
        <div class="eshocan_hero_main" >
            <div class="eshocan_hero_desc" data-aos="fade-right" data-aos-duration="1000">
                <h1>Automotive</h1>
                <h5>With technological advancement and market trends 
                    altering the shape and performance of vehicles, 
                    automotive OEMs are competing to shorten the life 
                    cycle of conceptualizing new products for market. 
                    That’s where we come in</h5>
            </div>
            <div class="eshocan_hero_media">
                <div class="Hero_media_big one" id="div9" data-aos="fade-left" data-aos-duration="1000">
                    <img class="video" src="img/Automotive/Hero.jpeg">
                </img>
            </div>
        </div>
    ...
    <section class="industries-info" data-aos="fade-right" data-aos-duration="1000">
        <h2 class="industries-info-head">Automotive</h2>
        <p class="industries-info-copy">eShocan is a partner to global automotive OEMs and Tier 1 suppliers, delivering a range of services tailored to address key industry challenges. With our engineering skills, development experience, familiarity with applications, and international access to relevant talent, we are equipped to provide quality services across the automotive product development life cycle.
            Our service focus areas are body panel and closures, exteriors, interiors and seating systems, powertrain, chassis system, and electrical and electronics. Our teams are led by a Subject Matter Expert (SME) from the automotive industry, who manages and mentors our engineers in the product development process as well as best methods and practices
            </p>
        ...
        <div class="industries-info-block">
            <img src="img/Automotive/Main infographic.png" alt="" data-aos="fade-right" data-aos-duration="1000">

            <div class="automotive-info-point" data-aos="fade-right" data-aos-duration="1000">
                <p class="automotive-info-point-head"></p>
                <ul>
                    ...
                    <li>Value analysis and value engineering</li>
                    <li>Engineering analysis & virtual simulation (CAE/CFD/MBD)</li>
                    <li>Industrial design and Class A surfacing</li>
                    <li>Design productivity services (automation and customization)</li>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back">
        <h1>Platform<br>Development</h1> 
        <p>eShocan has the expertise from Concept Engineering including Proof of Concepts development using OS like AGL, QNX Linux and AOSP.</p> 
        <a href="Aerospace.html">Aero Engines</a>
    </div>
  </div>
</div>
