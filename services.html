...
<body class="allPages">
    ...
    <section class="eshocan_hero_section" id="eshocan_hero_section">
        <div class="eshocan_hero_main" >
            <div class="eshocan_hero_desc" data-aos="fade-right" data-aos-duration="1000">
                <h1>Technology</h1>
                <h5>eShocan guides its clients through the maze of advanced technology trends and delivers complex solutions that unlock new business opportunities and revenue streams </h5>
            </div>
    ...
    <div class="popup-video">
        <span>&times;</span>
        <video src="img/services/vid.mp4" muted controls id="myvideo"></video>
    </div>
    ...
    <section class="industries-info" data-aos="fade-down" data-aos-duration="1000">
        <h2 class="industries-info-head">Technology</h2>
        <p class="industries-info-copy">eShocan guides its clients through the maze of advanced technology trends and delivers complex solutions that unlock new business opportunities and revenue streams. Our multi-domain experience and solid expertise in a variety of technology stacks make us a trustworthy partner for innovation-intensive projects of any scale involving AGL, QNX Linux, AOSP, data engineering, and emerging technology services</p>
    </section><!--industries-info-->

    <section class="industries-info services-what-we-do" data-aos="fade-down" data-aos-duration="1000">
        <h2 class="industries-info-head">What We do</h2>
        
        <img src="img/services/services-what we-do.png" alt="">
    </section><!--industries-info-->
    ...
    <section class="casestudy" style="padding-bottom: 3%;" data-aos="fade-down" data-aos-duration="1000">
        ...
        <div class="row inlinecasestudy">
            <h1 style="padding-top: 2%;">Case Studies</h1>
