...
<body class="allPages">
    ...
    <section class="eshocan_hero_section" id="eshocan_hero_section">
        <div class="eshocan_hero_main" >
            <div class="eshocan_hero_desc" data-aos="fade-right" data-aos-duration="1000">
                <h1 class="eshocan_hero_section_content">Research and<br> Development</h1>
            <h5>At eShocan, we want to help you validate new concepts and prepare your brightest ideas for production. For additional research and development expertise, we partner with ARMIS Corporation.</h5>
            </div>
            <div class="eshocan_hero_media">
                <div class="Hero_media_big one" id="div9" data-aos="fade-left" data-aos-duration="1000">
                    <img class="video" src="img/RnD/Hero.png">
                </img>
            </div>
        </div>
    ...
    <section class="industries-info">
        <div class="industries-info-block">
            <img src="img/RnD/main.png" alt="" data-aos="fade-right" data-aos-duration="1000" class="rnd_main_img">

            <div class="industries-info-content" data-aos="fade-left" data-aos-duration="1000">
                <div class="industries-info-content-block-auto">
                    <p class="industries-info-content-copy-rnd">
                        ARMIS is a team of researchers pulled from several universities and respected laboratories specializing in key domains such as robotics, power electronics, embedded security, and ADAS. The company follows a unique model of research and development by partnering with universities to validate research, build prototypes, and deliver technology to companies who sponsor their research. Following a business model of BUILD, OPERATE, and TRANSFER, ARMIS offers the following services:
                    </p>
                </div>
                <div class="industries-info-point" data-aos="fade-right" data-aos-duration="1000">
                    <ul>
                        <li>Development of HEV, PHEV, EV motor/inverter, controllers and converters </li>
                        <li>Motor and motor controller development consultancy (AC, DC, SRM, Bearing-less)</li>
                        <li>Power electronics training and development</li>
                        <li>Charging infrastructure</li>
                        <li>HiL (Hardware-in-loop) system for EV, HEV, PHEV </li>
                        <li>Building air conditioner power supply/inverter </li>
                        <li>Driver support system w/ milliwave radar vehicle tracking</li>
                        <li>Drone motors </li>
                        <li>Medical X-ray machines (including color x-rays) </li>
                        <li>Robotics/lobo-tics</li>
                    </ul>
                </div>
            </div>
        </div>
