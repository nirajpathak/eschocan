...
<body class="allPages">
    ...
    <section class="eshocan_hero_section" id="eshocan_hero_section">
        <div class="eshocan_hero_main" >
            <div class="eshocan_hero_desc" data-aos="fade-right" data-aos-duration="1000">
                <h1>Connected mobility</h1>
                <h5>Modern telematics and cloud connectivity enable OEMs to provide advanced mobility services and predictive maintenance.</h5>
            </div>
            <div class="eshocan_hero_media">
                <div class="Hero_media_big one" id="div9" data-aos="fade-left" data-aos-duration="1000">
                    <img class="video" src="img/ConnectedMobility/hero.jpeg">
                </img>
            </div>
        </div>
    ...
    <section class="industries-info" data-aos="fade-down" data-aos-duration="1000">
        <div class="industries-info-block">
            <img src="img/ConnectedMobility/main1.png" alt="" data-aos="fade-right" data-aos-duration="1000">
            ...
            <div class="industries-info-content" data-aos="fade-left" data-aos-duration="1000">
                <div class="industries-info-content-block-auto">
                    <p class="industries-info-content-head-auto">
                        Vehicle Diagnostics & Data Logging 
                    </p>
                    <p class="industries-info-content-copy">
                        eShocan provides Development, Porting, Integration and Testing of diagnostic modules based ISO14230, ISO14229, J1939, OBD-II, ODx standards. Our team has expertise on diagnostics services over interfaces like CAN, K-Line, LIN, SAE J2534 etc.<br>
                        We support the development of diagnostic modules like boot loader, Fault code memory, Flash drivers, application layer and drivers for communication interfaces.
                        We support development of vehicle network analyzers, simulators and data loggers using technologies like C#, C++, Java, Qt, .Net, and provide integration with IOS/Android and Cloud applications
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="industries-info-block">
            <div class="industries-info-content" data-aos="fade-right" data-aos-duration="1000">
                <div class="industries-info-content-block-auto-r">
                    ...
                    <p class="industries-info-content-copy">
                        Making different apps and tools to work as an integrated single unit allows for streamlining business operations and sharing data across various stakeholders. Leverage eShocan expertise in integrating telematics software with dispatching, customer relationship management (CRM), enterprise resource planning (ERP), or any other systems.
                    </p>
                </div>
            </div>
            <img src="img/ConnectedMobility/main2.png" alt="" data-aos="fade-left" data-aos-duration="1000">
        </div>
    ...
    <section class="casestudy" style="padding-bottom: 30px;" data-aos="fade-down" data-aos-duration="1000">
