...
<body class="allPages">
    ...
    <section class="eshocan_hero_section" id="eshocan_hero_section">
        <div class="eshocan_hero_main" >
            <div class="eshocan_hero_desc" data-aos="fade-right" data-aos-duration="1000">
                ...
                <h5>Manufacturers who want to sell their products overseas must adapt their designs to meet differing regulations such as emissions, safety, and warranties.</h5>
            </div>
            <div class="eshocan_hero_media">
                <div class="Hero_media_big one" id="div9" data-aos="fade-left" data-aos-duration="1000">
                    <img class="video" src="img/Heavy Machinary/Hero.png">
                </img>
            </div>
        </div>
    ...
    <section class="industries-info" data-aos="fade-down" data-aos-duration="1000">
        <h2 class="industries-info-head">Designing for International Market</h2>
        <p class="industries-info-copy">Manufacturers who want to sell their products overseas must adapt their designs to meet differing regulations such as emissions, safety, and warranties. To be competitive in developing countries, where growth potential is high, manufacturers need to find differentiated product lines. Designing for an international market presents new challenges. The common approach to “over-engineer” a design in some areas of the world complicates this process. With enhanced simulation capabilities, manufacturers can optimize the durability, adaptability, energy-efficiency and different material needs for their product variants without having to conduct multiple, time-consuming physical testing. Connecting global product teams via collaborative PLM tools can help manufacturers develop the right variants for new markets and reduce the potential for over-engineered product lines, launch delays and costly rework.
            eShocan’s consultants have worked with agricultural and construction machinery producers in exactly this capacity. We provide product development teams and subject matter experts with experience developing global variants using an optimal design strategy.            
            </p>
        ...
        <img src="img/Heavy Machinary/main.png" class="img-reponsive" alt="" data-aos="fade-right" data-aos-duration="1000">
